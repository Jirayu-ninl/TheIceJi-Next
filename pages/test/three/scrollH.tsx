...
function Page({ m = 0.4, urls, ...props }) {
  ...
  return (
    <group {...props}>
      <Image position={[-width * w, 0, -1]} scale={[width * w - m * 2, 5, 1]} url={urls[0]} alt='1'/>
      <Image position={[0, 0, 0]} scale={[width * w - m * 2, 5, 1]} url={urls[1]} alt='2'/>
      <Image position={[width * w, 0, 1]} scale={[width * w - m * 2, 5, 1]} url={urls[2]} alt='3'/>
    </group>
  )
}
...
function Pages() {
  ...
  return (
    <>
      <Page position={[-width * 1, 0, 0]} urls={['/mock/image/trip1.jpg', '/mock/image/trip2.jpg', '/mock/image/trip3.jpg']} />
      <Page position={[width * 0, 0, 0]} urls={['/mock/image/img1.jpg', '/mock/image/img2.jpg', '/mock/image/img3.jpg']} />
      <Page position={[width * 1, 0, 0]} urls={['/mock/image/img4.jpg', '/mock/image/img5.jpg', '/mock/image/img6.jpg']} />
      <Page position={[width * 2, 0, 0]} urls={['/mock/image/trip1.jpg', '/mock/image/trip2.jpg', '/mock/image/trip3.jpg']} />
      <Page position={[width * 3, 0, 0]} urls={['/mock/image/img1.jpg', '/mock/image/img2.jpg', '/mock/image/img3.jpg']} />
      <Page position={[width * 4, 0, 0]} urls={['/mock/image/img4.jpg', '/mock/image/img5.jpg', '/mock/image/img6.jpg']} />
    </>
  )
}
