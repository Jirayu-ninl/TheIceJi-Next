    ...
    <>
      <AnimatePresence>
        {toggleAbout && (
          ...
          >
            <div className="h-[182px] w-[339px] overflow-hidden rounded-md bg-[url('/gui/SplashBG.png')] drop-shadow-xl md:h-[363px] md:w-[677px]">
              <div className='h-full w-[150px] bg-[#02717C]/30 text-white backdrop-blur-md md:w-1/3'>
